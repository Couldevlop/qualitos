...
TRANSLATIONS = {
    ...
    'pfmea.revision': ('révision {{ p.revision }}', 'revision {{ p.revision }}', 'revisión {{ p.revision }}', 'المراجعة {{ p.revision }}', '改訂 {{ p.revision }}', '第 {{ p.revision }} 版'),
    ...
    'nc.create.matched-terms': ('termes communs : {{ choice.matchedTerms }}', 'shared terms: {{ choice.matchedTerms }}', 'términos comunes: {{ choice.matchedTerms }}', 'المصطلحات المشتركة: {{ choice.matchedTerms }}', '共通する語：{{ choice.matchedTerms }}', '共同词项：{{ choice.matchedTerms }}'),
