...
TRANSLATIONS = {
    ...
    "fives.heatmap.title": ("Scores 5S par zone", "5S scores by zone", "Puntuaciones 5S por zona", "درجات 5S حسب المنطقة", "ゾーン別5Sスコア", "按区域的5S评分"),
    "fives.heatmap.empty": ("Pas encore assez d'audits notés pour afficher la heatmap par zone.", "Not enough scored audits yet to display the heatmap by zone.", "Aún no hay suficientes auditorías puntuadas para mostrar el mapa de calor por zona.", "لا توجد تدقيقات مُقيّمة كافية بعد لعرض خريطة حرارية حسب المنطقة.", "ゾーン別ヒートマップを表示するには採点済み監査が不足しています。", "评分审核数量不足，暂无法按区域显示热力图。"),
    "fives.vision.title": ("Analyse visuelle (Vision IA)", "Visual analysis (AI Vision)", "Análisis visual (Visión IA)", "تحليل بصري (رؤية الذكاء الاصطناعي)", "画像解析（AIビジョン）", "视觉分析（AI视觉）"),
    "fives.vision.subtitle": ("Détecte automatiquement les non-conformités 5S (encombrement, EPI, étiquetage) sur une photo de la zone.", "Automatically detects 5S non-conformities (clutter, PPE, labelling) on a photo of the zone.", "Detecta automáticamente las no conformidades 5S (desorden, EPI, etiquetado) en una foto de la zona.", "يكتشف تلقائيًا حالات عدم المطابقة 5S (الفوضى، معدات الوقاية، الوسم) في صورة للمنطقة.", "ゾーンの写真から5S不適合（乱雑、PPE、ラベル表示）を自動検出します。", "自动从区域照片中检测5S不符合项（杂乱、个人防护装备、标签）。"),
    "fives.vision.analyze": ("Analyser une photo", "Analyze a photo", "Analizar una foto", "تحليل صورة", "写真を解析", "分析照片"),
    "fives.vision.clear": ("Effacer", "Clear", "Borrar", "مسح", "クリア", "清除"),
    "fives.vision.overall": ("Global", "Overall", "Global", "إجمالي", "総合", "总体"),
    "fives.vision.findings": ("Non-conformités détectées", "Detected non-conformities", "No conformidades detectadas", "حالات عدم المطابقة المكتشفة", "検出された不適合", "检测到的不符合项"),
    "fives.vision.no-findings": ("Aucune non-conformité détectée sur cette photo.", "No non-conformity detected on this photo.", "No se detectó ninguna no conformidad en esta foto.", "لم يتم اكتشاف أي حالة عدم مطابقة في هذه الصورة.", "この写真では不適合は検出されませんでした。", "该照片未检测到不符合项。"),
    "fives.vision.err-invalid": ("Image invalide (format non supporté).", "Invalid image (unsupported format).", "Imagen no válida (formato no admitido).", "صورة غير صالحة (تنسيق غير مدعوم).", "無効な画像（未対応の形式）。", "图像无效（不支持的格式）。"),
    "fives.vision.err-too-large": ("Image trop volumineuse (10 Mo max).", "Image too large (10 MB max).", "Imagen demasiado grande (10 MB máx).", "الصورة كبيرة جدًا (10 ميغابايت كحد أقصى).", "画像が大きすぎます（最大10MB）。", "图像过大（最大10 MB）。"),
    "fives.vision.err-unavailable": ("Le service d'analyse vision est momentanément indisponible.", "The vision analysis service is temporarily unavailable.", "El servicio de análisis visual no está disponible temporalmente.", "خدمة تحليل الرؤية غير متاحة مؤقتًا.", "画像解析サービスは一時的に利用できません。", "视觉分析服务暂时不可用。"),
    "fives.vision.err-generic": ("Échec de l'analyse vision.", "Vision analysis failed.", "Error en el análisis visual.", "فشل تحليل الرؤية.", "画像解析に失敗しました。", "视觉分析失败。"),
    ...
    "ishikawa.detail.convert-pdca": ("Convertir en PDCA", "Convert to PDCA", "Convertir a PDCA", "التحويل إلى PDCA", "PDCAに変換", "转换为PDCA"),
    "ishikawa.detail.convert-tooltip": ("Créer un cycle PDCA à partir de ce diagramme", "Create a PDCA cycle from this diagram", "Crear un ciclo PDCA a partir de este diagrama", "إنشاء دورة PDCA من هذا المخطط", "この図からPDCAサイクルを作成", "根据此图创建PDCA循环"),
    "ishikawa.detail.convert-success": ("Cycle PDCA créé à partir de ce diagramme.", "PDCA cycle created from this diagram.", "Ciclo PDCA creado a partir de este diagrama.", "تم إنشاء دورة PDCA من هذا المخطط.", "この図からPDCAサイクルを作成しました。", "已根据此图创建PDCA循环。"),
    "ishikawa.detail.convert-error": ("Échec de la conversion en PDCA.", "Failed to convert to PDCA.", "Error al convertir a PDCA.", "فشل التحويل إلى PDCA.", "PDCAへの変換に失敗しました。", "转换为PDCA失败。"),
    ...
    'spc.analyze.subtitle': ("Carte des valeurs individuelles — limites de contrôle (σ = MR̄/d₂) et 8 règles de Nelson.", 'Individuals chart — control limits (σ = MR̄/d₂) and 8 Nelson rules.', 'Gráfico de valores individuales — límites de control (σ = MR̄/d₂) y 8 reglas de Nelson.', 'مخطط القيم الفردية — حدود التحكم (σ = MR̄/d₂) و8 قواعد نيلسون.', '個別値管理図 — 管理限界（σ = MR̄/d₂）とネルソンの8ルール。', '单值控制图 — 控制限（σ = MR̄/d₂）和8条Nelson规则。'),
    ...
    'circles.minutes.title': ('Compte-rendu de réunion (IA)', 'Meeting minutes (AI)', 'Actas de reunión (IA)', 'محضر الاجتماع (ذكاء اصطناعي)', '会議議事録（AI）', '会议纪要（AI）'),
    'circles.minutes.meeting-label': ('Réunion :', 'Meeting:', 'Reunión:', 'الاجتماع:', '会議：', '会议：'),
    'circles.minutes.transcript-label': ('Transcript de la réunion', 'Meeting transcript', 'Transcripción de la reunión', 'نص الاجتماع', '会議トランスクリプト', '会议记录文本'),
    'circles.minutes.transcript-placeholder': ('Collez le texte brut de la réunion ici…', 'Paste the raw meeting text here…', 'Pegue el texto bruto de la reunión aquí…', 'الصق نص الاجتماع الخام هنا…', '会議の生テキストをここに貼り付けてください…', '在此粘贴会议原始文本…'),
    'circles.minutes.transcript-aria': ('Transcript de la réunion', 'Meeting transcript', 'Transcripción de la reunión', 'نص الاجتماع', '会議トランスクリプト', '会议记录文本'),
    'circles.minutes.transcript-hint': ("Collez le texte de la réunion. L'IA générera un résumé, les décisions et les actions.", 'Paste the meeting text. AI will generate a summary, decisions and actions.', 'Pegue el texto de la reunión. La IA generará un resumen, decisiones y acciones.', 'الصق نص الاجتماع. سيولّد الذكاء الاصطناعي ملخصاً وقرارات وإجراءات.', '会議テキストを貼り付けてください。AIが要約、決定事項、アクションを生成します。', '粘贴会议文本，AI将生成摘要、决策和行动项。'),
    'circles.minutes.generating': ('Génération en cours…', 'Generating…', 'Generando…', 'جارٍ التوليد…', '生成中…', '生成中…'),
    'circles.minutes.generate-error': ('Erreur lors de la génération du compte-rendu.', 'Error generating meeting minutes.', 'Error al generar las actas.', 'خطأ أثناء توليد محضر الاجتماع.', '議事録の生成中にエラーが発生しました。', '生成会议纪要时出错。'),
    'circles.minutes.summary-title': ('Résumé', 'Summary', 'Resumen', 'الملخص', '要約', '摘要'),
    'circles.minutes.decisions-title': ('Décisions', 'Decisions', 'Decisiones', 'القرارات', '決定事項', '决议'),
    'circles.minutes.actions-title': ('Actions', 'Actions', 'Acciones', 'الإجراءات', 'アクション', '行动项'),
    'circles.minutes.generate-btn': ('Générer le compte-rendu (IA)', 'Generate minutes (AI)', 'Generar actas (IA)', 'توليد المحضر (ذكاء اصطناعي)', '議事録を生成（AI）', '生成纪要（AI）'),
    'circles.minutes.open-btn': ('Compte-rendu IA', 'AI minutes', 'Actas IA', 'محضر ذكاء اصطناعي', 'AI議事録', 'AI纪要'),
    'circles.detail.proposal-actions': ('Actions', 'Actions', 'Acciones', 'الإجراءات', 'アクション', '操作'),
    'circles.proposal.review-tooltip': ('Examiner la proposition', 'Review proposal', 'Revisar propuesta', 'فحص المقترح', '提案を審査する', '审查提案'),
    'circles.proposal.approve-tooltip': ('Approuver la proposition', 'Approve proposal', 'Aprobar propuesta', 'اعتماد المقترح', '提案を承認する', '批准提案'),
    'circles.proposal.reject-tooltip': ('Rejeter la proposition', 'Reject proposal', 'Rechazar propuesta', 'رفض المقترح', '提案を却下する', '拒绝提案'),
    'circles.proposal.implement-tooltip': ('Marquer comme implémentée', 'Mark as implemented', 'Marcar como implementada', 'تحديد كمُنفَّذة', '実施済みとしてマーク', '标记为已实施'),
    'circles.proposal.impact-tooltip': ("Mesurer l'impact", 'Measure impact', 'Medir el impacto', 'قياس الأثر', 'インパクトを測定する', '测量影响'),
    'circles.proposal.reviewed': ("Proposition en cours d'examen.", 'Proposal under review.', 'Propuesta en revisión.', 'المقترح قيد الفحص.', '提案を審査中にしました。', '提案正在审查中。'),
    'circles.proposal.approved': ('Proposition approuvée.', 'Proposal approved.', 'Propuesta aprobada.', 'تم اعتماد المقترح.', '提案を承認しました。', '已批准提案。'),
    'circles.proposal.rejected': ('Proposition rejetée.', 'Proposal rejected.', 'Propuesta rechazada.', 'تم رفض المقترح.', '提案を却下しました。', '已拒绝提案。'),
    'circles.proposal.implemented': ('Proposition marquée comme implémentée.', 'Proposal marked as implemented.', 'Propuesta marcada como implementada.', 'تم تحديد المقترح كمُنفَّذة.', '提案を実施済みとしてマークしました。', '已将提案标记为已实施。'),
    'circles.proposal.impact-saved': ('Impact enregistré.', 'Impact recorded.', 'Impacto registrado.', 'تم حفظ الأثر.', 'インパクトを記録しました。', '已记录影响。'),
    'circles.proposal.action-error': ("Erreur lors de l'action.", 'Error during action.', 'Error durante la acción.', 'حدث خطأ أثناء الإجراء.', 'アクション中にエラーが発生しました。', '操作时出错。'),
    'circles.reject.title': ('Rejeter la proposition', 'Reject proposal', 'Rechazar propuesta', 'رفض المقترح', '提案を却下する', '拒绝提案'),
    'circles.reject.subtitle': ('Indiquez le motif du rejet pour informer le proposant.', 'Provide the rejection reason to inform the proposer.', 'Indique el motivo del rechazo para informar al proponente.', 'اذكر سبب الرفض لإبلاغ مُقدِّم المقترح.', '提案者に通知するために却下理由を入力してください。', '请提供拒绝原因以通知提案人。'),
    'circles.reject.submit': ('Rejeter', 'Reject', 'Rechazar', 'رفض', '却下する', '拒绝'),
    'circles.reject.reason-label': ('Motif du rejet', 'Rejection reason', 'Motivo de rechazo', 'سبب الرفض', '却下理由', '拒绝原因'),
    'circles.reject.reason-placeholder': ("Ex. : Budget insuffisant, hors périmètre du cercle, déjà traité…", 'E.g.: Insufficient budget, out of scope, already addressed…', 'Ej.: Presupuesto insuficiente, fuera del ámbito del círculo, ya tratado…', 'مثال: ميزانية غير كافية، خارج نطاق الحلقة، تمت معالجته بالفعل…', '例：予算不足、サークルの範囲外、すでに対応済み…', '例：预算不足、超出质量圈范围、已处理过…'),
    'circles.reject.reason-required': ('Le motif est requis.', 'Reason is required.', 'El motivo es obligatorio.', 'السبب مطلوب.', '理由は必須です。', '原因为必填项。'),
    'circles.reject.reason-min': ('5 caractères minimum.', 'Minimum 5 characters.', 'Mínimo 5 caracteres.', '5 أحرف على الأقل.', '最低5文字が必要です。', '最少5个字符。'),
    'circles.impact.title': ("Mesurer l'impact", 'Measure impact', 'Medir el impacto', 'قياس الأثر', 'インパクトを測定する', '测量影响'),
    'circles.impact.subtitle': ("Décrivez l'impact mesuré depuis l'implémentation de la proposition.", 'Describe the measured impact since implementing the proposal.', 'Describa el impacto medido desde la implementación de la propuesta.', 'صِف الأثر المُقاس منذ تنفيذ المقترح.', '提案の実施以来測定されたインパクトを記述してください。', '描述自实施提案以来测量到的影响。'),
    'circles.impact.submit': ("Enregistrer l'impact", 'Save impact', 'Guardar impacto', 'حفظ الأثر', 'インパクトを保存する', '保存影响'),
    'circles.impact.note-label': ("Note d'impact", 'Impact note', 'Nota de impacto', 'ملاحظة الأثر', 'インパクトメモ', '影响备注'),
    'circles.impact.note-placeholder': ("Ex. : Réduction des NC de 15%, gain de 30 min/jour, satisfaction opérateurs +2 points…", 'E.g.: 15% NC reduction, 30 min/day saved, operator satisfaction +2 points…', 'Ej.: Reducción de NC en un 15%, ahorro de 30 min/día, satisfacción operadores +2 puntos…', 'مثال: تقليل NC بنسبة 15٪، توفير 30 دقيقة يوميًا، رضا المشغلين +2 نقطة…', '例：NC 15%削減、1日30分節約、オペレーター満足度+2ポイント…', '例：NC减少15%，每天节省30分钟，操作员满意度+2分…'),
    'circles.impact.note-required': ("La note d'impact est requise.", 'Impact note is required.', 'La nota de impacto es obligatoria.', 'ملاحظة الأثر مطلوبة.', 'インパクトメモは必須です。', '影响备注为必填项。'),
    'circles.impact.note-min': ('5 caractères minimum.', 'Minimum 5 characters.', 'Mínimo 5 caracteres.', '5 أحرف على الأقل.', '最低5文字が必要です。', '最少5个字符。'),
