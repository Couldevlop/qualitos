...
INSERT INTO standard_clauses (id, section_id, code, title, description, order_index) VALUES
    ('52020001-0000-0000-0000-000000000002', '52010004-0000-0000-0000-000000000002', '4.1.1', 'Contexte — exigences sectorielles aérospatiales', 'Exigences réglementaires EASA, FAA, DGA, organismes équivalents.', 1),
    ('52020001-0000-0000-0000-000000000002', '52010004-0000-0000-0000-000000000002', '4.4.2', 'Sécurité produit', 'Plan de sécurité produit, classification criticité.', 2),
    ('52020002-0000-0000-0000-000000000002', '52010005-0000-0000-0000-000000000002', '5.1.1', 'Leadership — conscience sécurité produit', NULL, 1),
    ('52020003-0000-0000-0000-000000000002', '52010006-0000-0000-0000-000000000002', '6.1.1', 'Risques et opportunités — risk-based thinking aéro', 'Évaluation des risques produit, processus, programme.', 1),
    ('52020003-0000-0000-0000-000000000002', '52010006-0000-0000-0000-000000000002', '6.1.2', 'Gestion du risque opérationnel', 'Plan d''atténuation par risque identifié.', 2),
    ('52020004-0000-0000-0000-000000000002', '52010007-0000-0000-0000-000000000002', '7.2', 'Compétences — formation aéronautique spécifique', NULL, 1),
    ('52020004-0000-0000-0000-000000000002', '52010007-0000-0000-0000-000000000002', '7.3', 'Sensibilisation — pièces contrefaites & FOD', 'Programme de sensibilisation à la prévention des Counterfeit Parts et Foreign Object Debris.', 2),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.1.2', 'Prévention des pièces contrefaites', 'Procédure d''approvisionnement avec sources autorisées (OCM, OEM).', 1),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.1.3', 'Sécurité produit — analyse', 'Analyse FMEA orientée sécurité produit.', 2),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.1.4', 'Prévention des FOD', 'Programme FOD (Foreign Object Debris) sur lignes de production.', 3),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.3.4', 'Vérification et validation conception', NULL, 4),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.4.3', 'Maîtrise des fournisseurs externes', 'Validation, surveillance, performances fournisseurs aéro.', 5),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.5.1.1', 'Maîtrise des équipements — production aéronautique', NULL, 6),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.5.1.2', 'Validation des processus spéciaux', 'Procédés spéciaux (soudure, traitement thermique, NDT) — pré-qualification NADCAP.', 7),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.5.1.3', 'First Article Inspection (FAI)', 'FAI selon AS9102 pour pièces nouvelles ou modifiées.', 8),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.5.2', 'Identification et traçabilité', 'Traçabilité matière, lot, batch, série pour pièces critiques.', 9),
    ('52020005-0000-0000-0000-000000000002', '52010008-0000-0000-0000-000000000002', '8.5.4', 'Préservation', 'Préservation matériaux et produits durant manutention, stockage, transport.', 10),
    ('52020006-0000-0000-0000-000000000002', '52010009-0000-0000-0000-000000000002', '9.1.1', 'Surveillance & mesure — performance fournisseurs aéro', NULL, 1),
    ('52020007-0000-0000-0000-000000000002', '52010010-0000-0000-0000-000000000002', '10.2.1.1', 'Non-conformités — escape rate', 'Suivi escape rate (pièces NC livrées au client).', 1);

INSERT INTO standard_requirements (clause_id, code, text, obligation, evidence_types, measurable_criteria, risk_if_missing, order_index) VALUES
    ('52020001-0000-0000-0000-000000000002', '4.4.2', 'L''organisme doit assurer un plan de sécurité produit cohérent.', 'MUST', 'Plan de sécurité produit, registre des items critiques', 'Plan révisé ≥ 1/an, classification documentée', 'CRITICAL', 1),
    ('52020003-0000-0000-0000-000000000002', '6.1.1', 'L''organisme doit gérer les risques pour la sécurité du produit et la qualité.', 'MUST', 'Registre des risques aéro, FMEA', 'Couverture FMEA ≥ 90% des processus aéro', 'CRITICAL', 1),
    ('52020005-0000-0000-0000-000000000002', '8.1.2', 'L''organisme doit prévenir l''introduction de pièces contrefaites.', 'MUST', 'Procédure approvisionnement, liste sources autorisées', '100% approvisionnements depuis sources autorisées ou tracés', 'CRITICAL', 1),
    ('52020005-0000-0000-0000-000000000002', '8.1.4', 'L''organisme doit prévenir, détecter et éliminer les FOD.', 'MUST', 'Procédure FOD, audits FOD, registre incidents', 'Audit FOD ≥ 1/mois zones critiques, taux FOD escape ≤ 0.1%', 'CRITICAL', 1),
    ('52020005-0000-0000-0000-000000000002', '8.5.1.2', 'L''organisme doit valider les processus spéciaux à intervalles définis.', 'MUST', 'Rapports validation NADCAP, qualifications opérateurs', 'Re-qualification ≥ 1/an, opérateurs certifiés 100%', 'CRITICAL', 1),
    ('52020005-0000-0000-0000-000000000002', '8.5.1.3', 'L''organisme doit réaliser une FAI selon AS9102 pour toute nouvelle pièce ou modification.', 'MUST', 'Rapport FAI AS9102', 'FAI complet et signé avant production série, 100% des pièces nouvelles', 'CRITICAL', 1),
    ('52020005-0000-0000-0000-000000000002', '8.5.2', 'L''organisme doit assurer l''identification et la traçabilité tout au long de la production.', 'MUST', 'Registre traçabilité, marquage produit', '100% des pièces critiques traçables matière → livraison', 'CRITICAL', 1),
    ('52020007-0000-0000-0000-000000000002', '10.2.1.1', 'L''organisme doit suivre et améliorer son taux d''échappement de défauts (escape rate).', 'MUST', 'Indicateur escape rate, plans d''action', 'Escape rate < seuil contractuel client', 'HIGH', 1);
...
INSERT INTO standard_clauses (id, section_id, code, title, description, order_index) VALUES
    ('53020001-0000-0000-0000-000000000003', '53010004-0000-0000-0000-000000000003', '4.1.1', 'Exigences générales SMQ DM', 'SMQ documenté couvrant cycle de vie du DM.', 1),
    ('53020001-0000-0000-0000-000000000003', '53010004-0000-0000-0000-000000000003', '4.1.6', 'Validation des logiciels SMQ', 'Validation logiciels utilisés dans le SMQ et les processus de production.', 2),
    ('53020001-0000-0000-0000-000000000003', '53010004-0000-0000-0000-000000000003', '4.2.3', 'Dossier de dispositif médical', 'Dossier technique par DM (Device Master Record).', 3),
    ('53020002-0000-0000-0000-000000000003', '53010005-0000-0000-0000-000000000003', '5.5.2', 'Représentant de la direction', NULL, 1),
    ('53020003-0000-0000-0000-000000000003', '53010006-0000-0000-0000-000000000003', '6.4.1', 'Environnement de travail', 'Conditions environnementales pour conformité produit (salle blanche, ESD…).', 1),
    ('53020003-0000-0000-0000-000000000003', '53010006-0000-0000-0000-000000000003', '6.4.2', 'Maîtrise de la contamination', 'Mesures contre contamination produit & environnement.', 2),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.1', 'Planification de la réalisation du produit', NULL, 1),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.2.1', 'Détermination exigences clients (DM)', NULL, 2),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.3.2', 'Planification conception & développement', NULL, 3),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.3.7', 'Transfert de conception', 'Procédure transfert R&D → production.', 4),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.3.9', 'Gestion des modifications de conception', NULL, 5),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.4.1', 'Achats — sélection fournisseurs DM', NULL, 6),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.5.2', 'Propreté du produit', NULL, 7),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.5.5', 'Exigences particulières — DM stériles', 'Validation processus de stérilisation.', 8),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.5.6', 'Validation des processus de production', NULL, 9),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.5.8', 'Identification — UDI', 'Identification unique des dispositifs (UDI).', 10),
    ('53020004-0000-0000-0000-000000000003', '53010007-0000-0000-0000-000000000003', '7.5.9', 'Traçabilité', NULL, 11),
    ('53020005-0000-0000-0000-000000000003', '53010008-0000-0000-0000-000000000003', '8.2.1', 'Retour d''information (vigilance)', 'Système de surveillance après commercialisation (PMS).', 1),
    ('53020005-0000-0000-0000-000000000003', '53010008-0000-0000-0000-000000000003', '8.2.3', 'Reporting aux autorités réglementaires', 'Notification d''incidents (ANSM, FDA, etc.).', 2),
    ('53020005-0000-0000-0000-000000000003', '53010008-0000-0000-0000-000000000003', '8.3.4', 'Actions correctives — DM', NULL, 3);

INSERT INTO standard_requirements (clause_id, code, text, obligation, evidence_types, measurable_criteria, risk_if_missing, order_index) VALUES
    ('53020001-0000-0000-0000-000000000003', '4.1.6', 'L''organisme doit documenter les procédures de validation de l''application de logiciels utilisés dans le SMQ.', 'MUST', 'Plan de validation logiciels (CSV), rapports IQ/OQ/PQ', '100% logiciels SMQ critiques validés, re-validation après changement', 'CRITICAL', 1),
    ('53020001-0000-0000-0000-000000000003', '4.2.3', 'L''organisme doit établir un dossier pour chaque type ou famille de dispositif.', 'MUST', 'Device Master Record (DMR), Device History Record (DHR)', 'DMR à jour pour 100% DM commercialisés', 'CRITICAL', 1),
    ('53020003-0000-0000-0000-000000000003', '6.4.2', 'L''organisme doit planifier et documenter les exigences pour la maîtrise des produits contaminés ou potentiellement contaminés.', 'MUST', 'Procédure contamination, monitoring environnement', 'Monitoring particulaire/microbio dans tolérances, alarmes traitées < 24h', 'CRITICAL', 1),
    ('53020004-0000-0000-0000-000000000003', '7.3.7', 'L''organisme doit documenter les procédures de transfert de conception.', 'MUST', 'Procédure transfert R&D → industrialisation', 'Transfert documenté et validé avant production série', 'CRITICAL', 1),
    ('53020004-0000-0000-0000-000000000003', '7.5.5', 'Pour les DM stériles, l''organisme doit valider chaque processus de stérilisation.', 'MUST', 'Validation stérilisation (chaleur, gamma, EtO…)', 'Validation initiale + revalidation périodique', 'CRITICAL', 1),
    ('53020004-0000-0000-0000-000000000003', '7.5.8', 'L''organisme doit appliquer un UDI à chaque DM conformément aux exigences réglementaires applicables.', 'MUST', 'Registre UDI, intégration EUDAMED / GUDID', '100% DM avec UDI conforme au pays de mise sur marché', 'CRITICAL', 1),
    ('53020005-0000-0000-0000-000000000003', '8.2.1', 'L''organisme doit mettre en place une procédure documentée pour le retour d''information y compris la vigilance post-commercialisation.', 'MUST', 'Procédure vigilance, registre incidents', 'Délai analyse incident grave < 48h, déclaration autorité < 15j', 'CRITICAL', 1),
    ('53020005-0000-0000-0000-000000000003', '8.2.3', 'L''organisme doit signaler aux autorités tout incident répondant aux critères de signalement.', 'MUST', 'Rapports vigilance ANSM/FDA, suivi', '100% incidents éligibles signalés dans les délais réglementaires', 'CRITICAL', 1);
...
INSERT INTO standard_clauses (id, section_id, code, title, description, order_index) VALUES
    ('54020001-0000-0000-0000-000000000004', '54010001-0000-0000-0000-000000000004', '11.1', 'Scope', 'Records in electronic form created/modified/stored/transmitted under FDA regulations.', 1),
    ('54020001-0000-0000-0000-000000000004', '54010001-0000-0000-0000-000000000004', '11.2', 'Implementation', 'Equivalence with paper for FDA acceptance.', 2),
    ('54020001-0000-0000-0000-000000000004', '54010001-0000-0000-0000-000000000004', '11.3', 'Definitions', 'Definitions of biometrics, closed system, digital signature, electronic record, electronic signature.', 3),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(a)', 'Validation of systems', 'System validation to ensure accuracy, reliability, consistent intended performance, ability to discern invalid/altered records.', 1),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(b)', 'Generation of accurate copies', 'Ability to produce accurate and complete copies in human-readable and electronic form for inspection.', 2),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(c)', 'Protection of records', 'Records protection throughout retention period.', 3),
    ...
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(e)', 'Audit trails', 'Secure, computer-generated, time-stamped audit trails to record date/time of operator entries and actions; original information shall not be obscured.', 5),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(f)', 'Operational system checks', 'Sequencing of steps, events enforcement.', 6),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(g)', 'Authority checks', 'Authorized individuals can use the system, electronically sign, access, alter records.', 7),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(h)', 'Device (terminal) checks', 'Validity of the source of data input.', 8),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(i)', 'Education, training, experience', 'Personnel qualified for system use.', 9),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.10(k)', 'Documentation controls', 'Distribution, access, use of system documentation.', 10),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.30', 'Controls for open systems', 'Encryption + digital signature for open systems.', 11),
    ('54020002-0000-0000-0000-000000000004', '54010002-0000-0000-0000-000000000004', '11.50', 'Signature manifestations', 'Printed/displayed name, date/time, meaning of signature.', 12),
    ('54020003-0000-0000-0000-000000000004', '54010003-0000-0000-0000-000000000004', '11.100', 'General requirements (e-signature)', 'Unique to one individual, never reused, identity verified.', 1),
    ('54020003-0000-0000-0000-000000000004', '54010003-0000-0000-0000-000000000004', '11.200', 'Signature components and controls', 'Two distinct identification components (e.g. ID + password) for first signing in a session.', 2),
    ('54020003-0000-0000-0000-000000000004', '54010003-0000-0000-0000-000000000004', '11.300', 'Controls for identification codes/passwords', 'Uniqueness, periodic change, loss management, unauthorized use safeguards.', 3);

INSERT INTO standard_requirements (clause_id, code, text, obligation, evidence_types, measurable_criteria, risk_if_missing, order_index) VALUES
    ('54020002-0000-0000-0000-000000000004', '11.10(a)', 'Persons who use closed systems shall employ procedures and controls designed to ensure validation of systems to ensure accuracy, reliability, consistent intended performance, and the ability to discern invalid or altered records.', 'MUST', 'System Validation Plan, IQ/OQ/PQ reports, Validation Summary Report', 'CSV complète pour 100% systèmes GxP, re-validation après changement majeur', 'CRITICAL', 1),
    ('54020002-0000-0000-0000-000000000004', '11.10(e)', 'Secure, computer-generated, time-stamped audit trails to independently record the date and time of operator entries and actions that create, modify, or delete electronic records. Record changes shall not obscure previously recorded information.', 'MUST', 'Audit trail technique (DB triggers / event log), revue audit trail', 'Audit trail activé 100% des systèmes GxP, revue ≥ 1/mois pour systèmes critiques', 'CRITICAL', 1),
    ('54020002-0000-0000-0000-000000000004', '11.10(g)', 'Use of authority checks to ensure that only authorized individuals can use the system, electronically sign a record, access the operation or computer system input or output device, alter a record, or perform the operation at hand.', 'MUST', 'Matrice RBAC, logs accès, revue accès', 'Revue accès ≥ 1/trimestre, 0 partage de compte', 'CRITICAL', 1),
    ('54020003-0000-0000-0000-000000000004', '11.100', 'Each electronic signature shall be unique to one individual and shall not be reused by, or reassigned to, anyone else. Before an organization establishes, assigns, certifies, or otherwise sanctions an individual''s electronic signature, the organization shall verify the identity of the individual.', 'MUST', 'Procédure enregistrement utilisateur, preuve d''identification', '100% utilisateurs identifiés et vérifiés avant attribution e-signature', 'CRITICAL', 1),
    ('54020003-0000-0000-0000-000000000004', '11.200', 'Electronic signatures that are not based upon biometrics shall employ at least two distinct identification components such as an identification code and password.', 'MUST', 'Configuration système (MFA/2FA), preuve double composante', '2FA activé 100% pour e-signatures GxP', 'CRITICAL', 1),
    ('54020003-0000-0000-0000-000000000004', '11.300', 'Controls to ensure security and integrity of identification codes and passwords, including uniqueness, periodic checks, recalls, loss/theft management, transaction safeguards.', 'MUST', 'Politique mots de passe, rotation 90j, logs', 'Rotation password ≤ 90j, blocage après 5 échecs, alerte sur tentative anormale', 'CRITICAL', 1);
...
INSERT INTO standard_clauses (id, section_id, code, title, description, order_index) VALUES
    ('55020001-0000-0000-0000-000000000005', '55010004-0000-0000-0000-000000000005', '4.1', 'Compréhension du contexte (filière alimentaire)', NULL, 1),
    ('55020001-0000-0000-0000-000000000005', '55010004-0000-0000-0000-000000000005', '4.2', 'Parties intéressées (consommateur, autorité sanitaire)', NULL, 2),
    ('55020002-0000-0000-0000-000000000005', '55010005-0000-0000-0000-000000000005', '5.2', 'Politique sécurité des aliments', NULL, 1),
    ('55020003-0000-0000-0000-000000000005', '55010006-0000-0000-0000-000000000005', '6.2', 'Objectifs SMSDA', NULL, 1),
    ('55020004-0000-0000-0000-000000000005', '55010007-0000-0000-0000-000000000005', '7.1.6', 'Maîtrise des prestataires & sous-traitants', NULL, 1),
    ('55020004-0000-0000-0000-000000000005', '55010007-0000-0000-0000-000000000005', '7.2', 'Compétences (équipe HACCP)', NULL, 2),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.2', 'Programmes prérequis (PRP)', 'Construction, nettoyage/désinfection, lutte nuisibles, hygiène personnel.', 1),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.3', 'Système de traçabilité', 'Traçabilité amont/aval lot par lot.', 2),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.4.1', 'Préparation et réponse aux situations d''urgence', 'Plan de gestion crise alimentaire (retrait/rappel).', 3),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.5.1', 'Étapes préliminaires à l''analyse des dangers', 'Équipe HACCP, caractéristiques produit, diagramme de flux.', 4),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.5.2', 'Analyse des dangers (microbio, chimique, physique, allergènes)', NULL, 5),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.5.4', 'Plan de maîtrise des dangers (PRPo + CCP)', 'Identification CCP/PRPo + limites critiques.', 6),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.7', 'Maîtrise de la surveillance et de la mesure', NULL, 7),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.8', 'Vérification PRP et plan HACCP', NULL, 8),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.9.1', 'Maîtrise des non-conformités produits', 'Produits potentiellement dangereux : quarantaine, retrait, rappel.', 9),
    ('55020005-0000-0000-0000-000000000005', '55010008-0000-0000-0000-000000000005', '8.9.4', 'Retrait/rappel', 'Procédure documentée, exercice annuel.', 10),
    ('55020006-0000-0000-0000-000000000005', '55010009-0000-0000-0000-000000000005', '9.2', 'Audit interne SMSDA', NULL, 1),
    ('55020006-0000-0000-0000-000000000005', '55010009-0000-0000-0000-000000000005', '9.3', 'Revue de direction SMSDA', NULL, 2),
    ('55020007-0000-0000-0000-000000000005', '55010010-0000-0000-0000-000000000005', '10.2', 'Actions correctives (HACCP)', NULL, 1);

INSERT INTO standard_requirements (clause_id, code, text, obligation, evidence_types, measurable_criteria, risk_if_missing, order_index) VALUES
    ('55020005-0000-0000-0000-000000000005', '8.2', 'L''organisme doit établir, mettre en œuvre et tenir à jour des PRP pour aider à maîtriser la probabilité d''introduire des dangers liés à la sécurité des aliments.', 'MUST', 'Procédures PRP (nettoyage, hygiène, lutte nuisibles…)', 'Audit PRP ≥ 1/an, conformité ≥ 95%', 'CRITICAL', 1),
    ('55020005-0000-0000-0000-000000000005', '8.3', 'L''organisme doit établir un système de traçabilité permettant l''identification des lots, leur relation avec les lots de matières premières et les enregistrements de transformation et de livraison.', 'MUST', 'Système ERP traçabilité, exercice traçabilité', 'Temps de remontée traçabilité ≤ 2h, exactitude ≥ 99%', 'CRITICAL', 1),
    ('55020005-0000-0000-0000-000000000005', '8.5.2', 'L''équipe sécurité des aliments doit identifier et évaluer tous les dangers raisonnablement attendus en relation avec le type de produit, le procédé de production et les installations actuelles.', 'MUST', 'Analyse des dangers documentée par étape', 'Couverture 100% étapes du process, mise à jour à chaque changement', 'CRITICAL', 1),
    ('55020005-0000-0000-0000-000000000005', '8.5.4', 'L''organisme doit établir un plan de maîtrise des dangers qui identifie les CCP et leurs limites critiques.', 'MUST', 'Plan HACCP, registre CCP, limites critiques', '100% CCP identifiés avec limites validées scientifiquement', 'CRITICAL', 1),
    ('55020005-0000-0000-0000-000000000005', '8.7', 'L''organisme doit assurer la maîtrise des activités de surveillance et de mesure pour les CCP/PRPo (étalonnage, fréquence, méthodes).', 'MUST', 'Plans de surveillance, registres mesure, étalonnages', 'Surveillance CCP continue ou fréquence définie, étalonnage ≥ 1/an', 'CRITICAL', 1),
    ('55020005-0000-0000-0000-000000000005', '8.9.4', 'L''organisme doit établir une procédure de retrait/rappel.', 'MUST', 'Procédure retrait/rappel, exercices', 'Exercice de simulation ≥ 1/an, temps de réaction < 4h', 'CRITICAL', 1);
...
INSERT INTO standard_clauses (id, section_id, code, title, description, order_index) VALUES
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 5', 'Cadre de gouvernance et de contrôle interne (TIC)', 'L''organe de direction définit et approuve le cadre de gestion du risque TIC.', 1),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 6', 'Cadre de gestion du risque lié aux TIC', NULL, 2),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 7', 'Systèmes, protocoles et outils TIC', NULL, 3),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 8', 'Identification — actifs TIC, processus, dépendances', NULL, 4),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 9', 'Protection et prévention', 'Confidentialité, intégrité, disponibilité, authentification, autorisation.', 5),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 10', 'Détection (cybermenaces, anomalies)', NULL, 6),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 11', 'Réponse et reprise (continuité)', 'Plan de continuité, RTO/RPO, backups.', 7),
    ('56020002-0000-0000-0000-000000000006', '56010002-0000-0000-0000-000000000006', 'Art. 12', 'Apprentissage et évolution (post-incident)', NULL, 8),
    ('56020003-0000-0000-0000-000000000006', '56010003-0000-0000-0000-000000000006', 'Art. 17', 'Processus de gestion des incidents TIC', NULL, 1),
    ('56020003-0000-0000-0000-000000000006', '56010003-0000-0000-0000-000000000006', 'Art. 18', 'Classification des incidents', 'Critères : nombre clients impactés, criticité services, durée, impact réputationnel/économique.', 2),
    ('56020003-0000-0000-0000-000000000006', '56010003-0000-0000-0000-000000000006', 'Art. 19', 'Notification aux autorités (incidents majeurs)', 'Notification initiale ≤ 4h après classification, rapport intermédiaire, rapport final.', 3),
    ('56020004-0000-0000-0000-000000000006', '56010004-0000-0000-0000-000000000006', 'Art. 24', 'Programme de tests de résilience opérationnelle numérique', NULL, 1),
    ('56020004-0000-0000-0000-000000000006', '56010004-0000-0000-0000-000000000006', 'Art. 25', 'Tests généraux (annuels)', 'Tests de vulnérabilité, scénarios, source code review pour systèmes critiques.', 2),
    ('56020004-0000-0000-0000-000000000006', '56010004-0000-0000-0000-000000000006', 'Art. 26', 'Tests avancés — TLPT (Threat-Led Penetration Testing)', 'TLPT au moins tous les 3 ans pour entités significatives.', 3),
    ('56020005-0000-0000-0000-000000000006', '56010005-0000-0000-0000-000000000006', 'Art. 28', 'Principes généraux — risques prestataires TIC tiers', NULL, 1),
    ('56020005-0000-0000-0000-000000000006', '56010005-0000-0000-0000-000000000006', 'Art. 29', 'Évaluation préliminaire — concentration TIC', NULL, 2),
    ('56020005-0000-0000-0000-000000000006', '56010005-0000-0000-0000-000000000006', 'Art. 30', 'Dispositions contractuelles', 'Clauses minimales obligatoires dans contrats TIC : audit, exit, sécurité, localisation.', 3),
    ('56020005-0000-0000-0000-000000000006', '56010005-0000-0000-0000-000000000006', 'Art. 31', 'Désignation des prestataires TIC tiers critiques', 'Désignation par les ESA, supervision directe.', 4);

INSERT INTO standard_requirements (clause_id, code, text, obligation, evidence_types, measurable_criteria, risk_if_missing, order_index) VALUES
    ('56020002-0000-0000-0000-000000000006', 'Art. 5', 'L''organe de direction de l''entité financière définit, approuve, supervise et est responsable de la mise en œuvre de tous les dispositifs liés au cadre de gestion du risque lié aux TIC.', 'MUST', 'Charte de gouvernance TIC, PV organe de direction', 'Cadre approuvé en formelle ≥ 1/an, revue annuelle', 'CRITICAL', 1),
    ('56020002-0000-0000-0000-000000000006', 'Art. 6', 'Les entités financières disposent d''un cadre de gestion du risque lié aux TIC solide, complet et bien documenté.', 'MUST', 'Cadre formalisé, registre des risques TIC', 'Cadre documenté, registre maintenu, revue ≥ 1/an', 'CRITICAL', 1),
    ('56020002-0000-0000-0000-000000000006', 'Art. 8', 'Les entités identifient, classent et documentent toutes les fonctions opérationnelles supportées par les TIC, les rôles, ainsi que les actifs informatiques et leurs interdépendances.', 'MUST', 'Inventaire actifs TIC, cartographie dépendances', 'Inventaire à jour, mise à jour ≥ 1/an, 100% fonctions critiques cartographiées', 'CRITICAL', 1),
    ('56020003-0000-0000-0000-000000000006', 'Art. 17', 'Les entités financières définissent, établissent et mettent en œuvre un processus de gestion des incidents liés aux TIC.', 'MUST', 'Procédure de gestion incidents TIC', 'Procédure formalisée, RACI, tests', 'CRITICAL', 1),
    ('56020003-0000-0000-0000-000000000006', 'Art. 19', 'Les entités financières notifient l''autorité compétente sans retard injustifié l''incident TIC majeur en respectant les délais réglementaires.', 'MUST', 'Procédure notification, registre incidents majeurs', 'Notification initiale ≤ 4h, rapport intermédiaire ≤ 72h, rapport final ≤ 1 mois', 'CRITICAL', 1),
    ('56020004-0000-0000-0000-000000000006', 'Art. 24', 'Les entités financières mettent en place, maintiennent et révisent un programme solide et complet de tests de résilience opérationnelle numérique.', 'MUST', 'Programme de tests, calendrier, rapports', 'Programme révisé ≥ 1/an, exécution selon calendrier', 'CRITICAL', 1),
    ('56020004-0000-0000-0000-000000000006', 'Art. 26', 'Les entités significatives effectuent des tests avancés (TLPT) au moins une fois tous les trois ans.', 'MUST', 'Rapport TLPT, plan d''action', 'TLPT exécuté ≤ 3 ans pour entités significatives, conduit par testeurs accrédités', 'CRITICAL', 1),
    ('56020005-0000-0000-0000-000000000006', 'Art. 30', 'Les contrats entre les entités financières et les prestataires TIC tiers comportent les clauses obligatoires DORA (description services, lieux, sécurité, accès/audit, RTO/RPO, exit).', 'MUST', 'Registre contrats TIC, clauses contractuelles', '100% nouveaux contrats TIC alignés DORA, contrats existants migrés ≤ 17/01/2025', 'CRITICAL', 1);
